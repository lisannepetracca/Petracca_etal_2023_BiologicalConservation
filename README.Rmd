...
This repo details how to run the spatially-explicit projection model submitted to Journal of Applied Ecology by Petracca et al. 
...
The "data" section has all data (in .Rdata formatting) needed to run all models. See a_DESCRIPTION.txt for more.
