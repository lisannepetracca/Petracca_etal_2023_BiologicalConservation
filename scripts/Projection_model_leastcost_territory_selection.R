#---
#"Projection model for baseline scenario, least cost path territory selection method"
#"Lisanne Petracca"
#"Nov 2022"
#---
...
load("GitHub/Petracca_et_al_EcoApps/data/Least_cost_territory_selection_information.RData") #LCP

#load all functions
source("GitHub/Petracca_et_al_EcoApps/functions/movement_function_singlelcp.R")
...
for(sim in 1:nSims){
  ...
  new.guys <- get.move(n.settlers.for.fxn,n.res,site_check,mat_singleLCP)  
...
save(Lambda.mean, 
     ...
     NSite_state.mean, NSite_EWash.mean, NSite_NCasc.mean, NSite_SCasc.mean, file="GitHub/Petracca_et_al_EcoApps/baseline_leastcost.RData")
